...
def main(argv):
    ...
    myParser.add_argument("-v", "--vm", help="VM to expire backups from", required=True)
...
#    endpoint = "vms?"
    ...
    vm_name = vm_data[0]['vmName']
    vm_type = vm_data[0]['externalHypervisorType']
