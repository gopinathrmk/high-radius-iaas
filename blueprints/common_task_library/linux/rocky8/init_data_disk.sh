...
sudo mkdir @@{data_volume_mount_point}@@
sudo mount /dev/vg0/data @@{data_volume_mount_point}@@
echo '/dev/mapper/vg0-data @@{data_volume_mount_point}@@ ext4 defaults 0 0' | sudo tee -a /etc/fstab